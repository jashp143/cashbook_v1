...
class ExpenseFormScreen extends StatefulWidget {
  ...
  const ExpenseFormScreen({super.key, this.transactionToEdit});
    ...
    try {
      ...
      if (isEditing) {
        ...
        if (mounted) {
          final l10n = AppLocalizations.of(context)!;
          Fluttertoast.showToast(
            msg: l10n.expenseUpdatedSuccessfully,
            toastLength: Toast.LENGTH_SHORT,
          );
          context.go('/');
        }
        ...
        if (mounted) {
          final l10n = AppLocalizations.of(context)!;
          Fluttertoast.showToast(
            msg: l10n.expenseAddedSuccessfully,
            toastLength: Toast.LENGTH_SHORT,
          );
          context.go('/');
        }
    ...
    return PopScope(
      ...
      child: Builder(
        builder: (context) {
          ...
          return Scaffold(
            appBar: AppBar(
              title: Text(widget.transactionToEdit != null ? l10n.editExpense : l10n.addExpense),
              leading: IconButton(
                    ...
                    child: SafeArea(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(widget.transactionToEdit != null ? l10n.updateExpense : l10n.saveExpense),
                        ),
                      ),
                    ),
                  ),
